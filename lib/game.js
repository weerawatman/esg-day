...
export class Game {
 ...
 create(demo=false){
  ...
  const r={code,hostToken:token(),phase:'lobby',q:0,players:[],answers:{},voided:[],deadline:0,created:this.now(),demo:Boolean(demo),seconds:20,rules:structuredClone({version:2,questions,teams})};
  this.rooms[code]=r;
